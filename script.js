...
const signUp = e => {
    ...
    // Nối data từ cái form của m với local storage trong "formData". Mở console ra sẽ thấy cái formData: "..." chứa thông tin đăng nhập
    // T console log ra cho dễ nhìn rồi đấy
